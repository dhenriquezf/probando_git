        ...
        $('a.button.process').click(function(){
                ...
                if(body.hasClass('encrypt')){
                        ...
                        reader.onload = function(e){
								...
								var key = CryptoJS.enc.Utf8.parse('12EstaClave34es56dificil489ssswf');
								var iv = CryptoJS.enc.Utf8.parse('Devjoker7737hAES');
								/*
								var data = [];
								for (var i = 0; i < key.length; i++){  
									data.push(key.charCodeAt(i));
								}
								var data2 = [];
								for (var i = 0; i < iv.length; i++){  
									data2.push(iv.charCodeAt(i));
								}*/
								//var texto = CryptoJS.enc.Utf8.parse(e.target.result);
                                ...
                                //var encrypted = CryptoJS.AES.encrypt(e.target.result, password, {iv: iv});
